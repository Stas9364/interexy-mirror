...
export const termsContent = (
  <>
    ...
    <p>
      ...
      Website. We reserve the right to update or modify these Terms at any time, and your
    ...
    <ul>
      <li>
        Copy, reproduce, distribute, or modify any content from this Website without prior
        written consent from Interexy.
      </li>
      <li>
        Use the Website in any way that could damage, disable, overburden, or impair its
        functionality.
      </li>
      <li>
        Attempt to gain unauthorized access to any parts of the Website, including its
        servers, systems, or user data.
      </li>
      <li>Use the Website for any illegal, fraudulent, or harmful activities.</li>
    </ul>
    <p>
      Interexy reserves the right to restrict, suspend, or terminate your access to the
    ...
    <p>
      ...
      protected by copyright, trademark, and other applicable laws worldwide, including
      the United States, Poland, and the UAE.
    </p>
    <p>
      You may not use, copy, distribute, or display Interexy’s intellectual property
      without prior written permission. Any unauthorized use may result in legal action
    ...
    <p>
      ...
      other industry-standard practices. For details on how we collect, process, and store
    ...
    <ul>
      ...
      <li>
        Damages resulting from the use or inability to use the Website, or reliance on any
        information provided on the Website.
      </li>
    </ul>
    <p>
      This limitation of liability applies to users in all jurisdictions, including the
    ...
    <p>
      The Website and all content are provided “as is” and “as available” without any
    ...
    <ul>
      <li>
        Local laws in your country or region (including UAE privacy laws, GDPR for EU
        users, and any U.S. laws).
      </li>
      <li>
        User conduct rules, ensuring you do not engage in harmful, fraudulent, or illegal
    ...
    <p>
      ...
      policies, or practices of any third-party websites. Your use of linked sites is at
      your own risk.
    </p>
    ...
    <p>
      If you use this Website from outside the United States, you agree that any disputes
      will be subject to the jurisdiction of the courts located in Florida, USA. By using
      the Website, you waive any claims that may arise under the laws of other
    ...
    <p>
      Arbitration will take place in Florida, USA, and will be conducted in English. By
      using this Website, you waive any right to pursue disputes in court (except for
    ...
    <p>
      ...
      continued use of the Website after changes are made constitutes your acceptance of
      the revised Terms.
    </p>
    ...
    <ul>
      ...
      <li>Acts of government (lockdowns, new regulations, export restrictions);</li>
      <li>War, civil unrest, riots, or other political disturbances;</li>
      <li>Power outages, technical issues, or supply chain disruptions.</li>
    </ul>
    <p>
      This clause applies to events affecting Interexy’s offices in the United States,
      Poland, and the UAE.
    </p>
