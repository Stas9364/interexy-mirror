import type { FaqType } from '@/components/service-blocks/faq/faq-types';

export const nftFaq: FaqType[] = [
  {
    question: 'What is NFT Marketplace app development?',
    answer: [
  ...
  {
    question: 'How do NFT Marketplaces Make Money?',
    answer: [
  ...
  {
    question: 'How to Start an NFT Marketplace?',
    answer: [
  ...
  {
    question: 'How Much Does It Cost to Create an Nft Marketplace?',
    answer: [
