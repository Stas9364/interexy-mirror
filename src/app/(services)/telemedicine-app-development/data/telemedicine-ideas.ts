...
export const telemedicineIdeas: PostT[] = [
  {
    image: '/services/telemedicine-app-development/11-1-1024x238.webp',
  ...
  {
    image: '/services/telemedicine-app-development/small-banner-25.webp',
  ...
  {
    image: '/services/telemedicine-app-development/small-banner-27.webp',
  ...
  {
    image:
      '/services/telemedicine-app-development/businessman-working-with-digital-finance-business-graph-perceptive-technology-1-2.webp',
  ...
  {
    image: '/services/telemedicine-app-development/generative-ai.webp',
  ...
  {
    image: '/services/telemedicine-app-development/health-monitoring-app-1.webp',
    title: '10 Steps on How to Create a Telehealth App Successfully',
    excerpt:
