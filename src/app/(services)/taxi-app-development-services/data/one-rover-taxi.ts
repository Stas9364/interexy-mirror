...
export const oneRoverTaxi: FullCycleItem[] = [
  {
    title: 'One Rover',
    tags: ['Android', 'Delivery', 'iOS', 'USA'],
    description:
    ...
    points: [
      ...
      },
      {
        title: 'Solution',
        description:
          'During the development process we faced different issues, some of them: Building a product from scratch; Matching Algorithm, Geofencing & Driver Payments; Different Applications for Different Entities',
      },
      {
        title: 'Result',
        description:
    ...
    src_img: '/services/delivery-app-development-services/One-Rover.png',
  },
];
