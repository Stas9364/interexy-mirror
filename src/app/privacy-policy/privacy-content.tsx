...
export const privacyContent = (
  <>
    <p>
      This Privacy Notice explains how Interexy LLC (<strong>“we”</strong>,{' '}
      <strong>“us”</strong>, or <strong>“our”</strong>) collects, uses, stores, and shares
      (<strong>“processes”</strong>) your personal information when you interact with our
      services (<strong>“Services”</strong>). This includes:
    </p>

    <ul>
      <li>
        Visiting our website at interexy.com or any website that links to this Privacy
        Notice.
      </li>
      <li>Engaging with us through sales, marketing, or events.</li>
    </ul>

    <p>
      We collect personal information to improve your experience, provide our services
      effectively, and comply with legal obligations. By understanding how we process your
      information, you can make informed choices about your privacy. If you have any
    ...
    <ul>
      <li>
        ...
        Services (such as the date/time stamps associated with your usage, pages and files
    ...
    <p>
      ...
      data providers, and from other third parties. This information includes mailing
    ...
    <ul>
      ...
      <li>
        ...
        information to develop and display personalized content and advertising tailored
    ...
    <h3>For those located in the EU or UK</h3>
    ...
    <h3>For those located in Canada</h3>
    ...
    <p className='footnote'>
      ...
      <em>
        We keep your personal information only as long as necessary to fulfill the
    ...
    <p>
      We keep your personal information for as long as it is needed to achieve the
      purposes described in this Privacy Policy, such as providing our services, complying
      with legal obligations, resolving disputes, and enforcing our agreements. The exact
      retention period depends on the nature of the information and the context of its
      processing.
    </p>

    <p>
      When we no longer have a legitimate business need to process your personal
      information, we will delete, anonymize, or securely store it until deletion is
      possible. In cases where immediate deletion is not feasible (for instance, if the
      information is stored in backup archives), we will safeguard it and restrict any
    ...
    <p>
      We have implemented appropriate and reasonable security measures to protect your
      personal information from unauthorized access, disclosure, alteration, or
      destruction. Our approach includes:
    </p>

    <ul>
      <li>
        <strong>Data Encryption:</strong> Sensitive information is encrypted to maintain
        confidentiality.
      </li>
      <li>
        <strong>Firewalls and Access Controls:</strong> We use advanced firewalls and
        role-based access controls to prevent unauthorized access to our systems.
      </li>
      <li>
        <strong>Regular Security Audits:</strong> Our systems are regularly assessed
        through vulnerability scans and security audits to identify and address potential
        risks.
      </li>
      <li>
        <strong>Secure Data Storage:</strong> Personal data is stored on secure servers
        with restricted access for authorized personnel only.
      </li>
    </ul>

    <p>
      Despite our safeguards, no electronic transmission over the Internet or information
      storage technology can be guaranteed as 100% secure. While we strive to maintain the
      highest security standards, we cannot guarantee that hackers, cybercriminals, or
      other unauthorized parties will not be able to access, steal, or modify your
      information. We encourage you to access our services from a secure environment and
    ...
    <p className='footnote'>
      ...
      <em>
        In some regions, such as the European Economic Area (EEA), United Kingdom (UK),
    ...
    <p className='footnote'>
      ...
      <em>
        If you are a resident of California, Colorado, Connecticut, Utah or Virginia, you
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td data-status='positive'>Yes</td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            ...
            <td>Contents of email or text messages and precise geolocation</td>
            <td data-status='positive'>Yes</td>
          </tr>
        </tbody>
      </table>
    ...
    <p>
      ...
      contractor, for additional, specified purposes. You have the right to limit the use
    ...
    <p>
      you have the right to direct that business to limit its use of your sensitive
      personal information to that use which is necessary to perform the Services.
    </p>
    ...
    <p>
      Please note that sensitive personal information that is collected or processed
      without the purpose of inferring characteristics about a consumer is not covered by
      this right, as well as the publicly available information.
    </p>
    ...
    <p>
      ...
      decision, please email us at info@interexy.com. Within forty-five (45) days of
    ...
    <p>
      If we decline to take action regarding your request and you wish to appeal our
      decision, please email us at info@interexy.com. Within sixty (60) days of receipt of
    ...
    <p>
      ...
      (UCPA), you have the rights listed below. However, these rights are not absolute,
    ...
    <p>
      ...
      in an individual or household context. It does not include a natural person acting
    ...
    <p>
      ...
      such extension within the initial 45-day response period, together with the reason
      for the extension.
    </p>
    ...
    <p>
      ...
      decision and reasoning behind it. If you wish to appeal our decision, please email
      us at info@interexy.com. Within sixty (60) days of receipt of an appeal, we will
    ...
    <p>
      ...
      details provided in the section “How can you review, update, or delete the data we
      collect from you?”
    </p>
    ...
    <p>
      <a href='https://inforegulator.org.za/' target='_blank' rel='noopener nofollow'>
    ...
    <p>
      ...
      info@interexy.com or contact us by post at:
    </p>

    <p>Interexy LLC</p>
    <p>11820 Miramar Pkwy #125</p>
