    ...
    <div className="h-full hidden lg:flex items-center">
      {menuData.map(({ title, subtitle, submenu, link }) => (
        <div key={title} className="relative group h-full">
          ...
          {!link && (
            <div className="fixed top-[101px] left-0 right-0 shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-in-out z-50">
